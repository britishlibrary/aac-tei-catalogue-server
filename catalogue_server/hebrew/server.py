...
config = yaml.safe_load(open('catalogue_server/hebrew/configuration.yml', 'r'))
...
template_env = Environment(
    loader=PackageLoader('catalogue_server.hebrew', 'templates'),
...
app.static('/static/hebrew', 'catalogue_server/hebrew/static')
