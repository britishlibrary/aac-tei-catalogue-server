...
config = yaml.safe_load(open('catalogue_server/fihrist/configuration.yml', 'r'))
...
template_env = Environment(
    loader=PackageLoader('catalogue_server.fihrist', 'templates'),
...
app.static('/static/fihrist', 'catalogue_server/fihrist/static')
